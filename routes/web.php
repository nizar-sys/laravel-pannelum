...
Route::get('/virtual-tour', 'SceneController@pannellum')->name('virtual-tour');
...
Route::post('/settings/save', 'SettingController@saveSettings')->name('settings.save')->middleware('auth');

Route::get('/helps', 'HomeController@helpPage')->name('helps');
